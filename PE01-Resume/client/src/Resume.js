    ...
    return (
        <div className="resume">
            <header className="header">
                <h1>Studen Name</h1>
                <p>123 Main Street, Anytown USA, 123456 | (123) 456-7890 | studentname@email.com</p>
            </header>
            ...
            <section className="section">
                ...
                <div className="education">
                    ...
                    <p>University of Anytown, Anytown USA | May 2023</p>
                    <p>GPA: 3.8/4.0</p>
                    <h3>Bachelor of Science in Computer Science</h3>
                    <p>University of Anytown, Anytown USA | May 2021</p>
                    <p>GPA: 3.6/4.0</p>
                </div>
            </section>
            ...
            <section className="section">
                ...
                <div className="projects">
                    ...
                    <p>Source code:{" "} <a href="https://github.com/studentname/personal-website" target="_blank" rel="noopener noreferrer">GitHub</a></p>

                    <h3>Online Bookstore</h3>
                    <p>Developed a web application for an online bookstore using Spring Boot and MySQL</p>
                    <p>Source code:{" "} <a href="https://github.com/studentname/online-bookstore" target="_blank" rel="noopener noreferrer">GitHub</a></p>
                </div>
            </section>
        </div>
    )
